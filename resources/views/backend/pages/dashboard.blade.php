    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        ...
        <div class="circle-tile-content dark-blue">
          ...
          <a class="circle-tile-footer" href="{{route('customers')}}">More Info<i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div>
    ...
    <div class="col-lg-2 col-sm-6">
      <div class="circle-tile ">
        ...
        <div class="circle-tile-content yellow">
          <div class="circle-tile-description text-faded">Total Product  </div>
          <div class="circle-tile-number text-faded ">{{ $productCount}}</div>
          <a class="circle-tile-footer" href="{{route('products')}}">More Info<i class="fa fa-chevron-circle-right"></i></a>
        </div>
      </div>
    </div> 
    <div class="col-lg-2 col-sm-6">
...
<div class="col-lg-2 col-sm-6">
  <div class="circle-tile ">
    <a href="#"><div class="circle-tile-heading green"><i class="fa fa-shopping-cart fa-fw fa-3x"></i></div></a>
    <div class="circle-tile-content green">
      <div class="circle-tile-description text-faded"> Today Sale </div>
      <div class="circle-tile-number text-faded ">{{$todaySale}}</div>
      <a class="circle-tile-footer" href="{{route('order.list')}}">More Info<i class="fa fa-chevron-circle-right"></i></a>
    </div>
  </div>
</div>
