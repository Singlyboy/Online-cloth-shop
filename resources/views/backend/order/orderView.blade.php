...
<html lang="zxx">
  ...
  <body>
    <!-- Invoice 2 start -->
    <div class="invoice-2 invoice-content mt-5">
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="invoice-inner clearfix">
              <div class="invoice-info clearfix" id="invoice_wrapper">
                  ...
                  <div class="row">
                    <div class="col-sm-6 col-lg-6">
                      <div class="invoice-number mb-50">
                        ...
                        <div>Phone: {{$orders->receiver_mobile_no}}</div>
                        </p>
                      </div>
                    </div>
                    <div class="col-sm-6 col-lg-6">
                      <div class="invoice-number mb-30">
                        <div class="invoice-number-inner">
                          ...
                          <h2 class="name">EShopper</h2>
                          <p class="invo-addr-1"> EShopper  <br /> Email:eshoper@gmail.com <br /> Uttara, Dhaka, Bangladesh <br /> Mobile: 016000000000 <br />
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div class="invoice-center">
                  <div class="table-responsive">
                    <table class="table mb-0 table-striped invoice-table">
                      ...
                      <tbody> @foreach ($orders->orderDetails as $item) <tr class="tr">
                          <td>
                ...
                <form action="{{route('order.status',$item->order_id)}}" method="post"> @csrf <select name="order_status" class="form-select" aria-label="Default select example">
